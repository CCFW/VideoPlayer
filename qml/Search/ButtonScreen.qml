        ...
        Menu {
            ...
            Action {
                ...
                onTriggered: {
                    ...
                    //                    for(var i=searchhomepage.listmodes.count-1; i>=0;i--){
                    //                        if(0>searchhomepage.listmodes.get(i).time||searchhomepage.listmodes.get(i).time>10){
                    //                            searchhomepage.listmodes.remove(i)
                    //                        }
                    //                    }
                    //                    dataManage.clearVector()
            ...
            Action {
                ...
                onTriggered: {
                    ...
                    //                        if(11>searchhomepage.listmodes.get(j).time||searchhomepage.listmodes.get(j).time>30){
            ...
            Action {
                ...
                onTriggered: {
                    ...
                    //                    }
                    //                    for(var j=searchhomepage.listmodes.count-1; j>=0;j--){
                    //                        if(31>searchhomepage.listmodes.get(j).time||searchhomepage.listmodes.get(j).time>=60){
                    //                            searchhomepage.listmodes.remove(j)
                    //                        }
                    //                    }
                    //                    dataManage.clearVector()
