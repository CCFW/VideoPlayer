...
Rectangle{
    ...
    Rectangle{
        ...
        MediaPlayer{
            id: mediaPlayer
            source: "qrc:/images/video/vedio1.mp4"
            autoPlay: true
    ...
    Rectangle{
        ...
        Image {
            id: danMuClose
            visible: true
            source: "qrc:/images/danMuClose.png"
            anchors.left: parent.left
        ...
        Image {
            id: danMuOpen
            visible: false
            source: "qrc:/images/danMuOpen.png"
            anchors.left: parent.left
            anchors.leftMargin: 350
            anchors.top: parent.top
            anchors.topMargin: 20
        ...
        Rectangle{
            ...
            Text {
                id: danMuPrompt3
                font.pixelSize: 20
                anchors.left: danMuPrompt2.right
                anchors.verticalCenter: parent.verticalCenter
                text: qsTr("后来一发吧！")
            }
        }
        ...
        Row{
            ...
            Controls14.Slider{
                ...
                onPressedChanged: {
                    if(value < 0.5){
                        volumeKey.source = "qrc:/images/volume1.png"
                    }else if(value >= 0.5){
                        volumeKey.source = "qrc:/images/volume.png"
                    }else if(value == 0.0){
                        volumeKey.source = "qrc:/images/volume0.png"
                    }
                }
                stepSize: 0.01
                //此属性保存滑块的最大值,默认值是1.0
