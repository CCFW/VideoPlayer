...
Rectangle{
    ...
    property alias introductionDescText: introductionDescText.text
    ...
    function danMu(){
        ...
        var i = 0;
        while(i < a){
            //                        console.log(danMuSql.getDanMu()[i])
            var temp = danMuSql.getDanMu()[i]
    ...
    function comment(){
        ...
        //        console.log(typeof(danMuSql.getComments()[0]))
        var i = 0;
        while(i < a){
            if(i == 0){
                model1.remove(0)
            ...
            //评论内容初始化
            model1.append({"portrait": danMuSql.getAvatar()[i],"name": danMuSql.getName()[i],"commenttext": danMuSql.getComments()[i]});
    ...
    Rectangle{
            ...
            Text {
                ...
                MouseArea{
                    ...
                    onClicked: {
                        ...
                        //                        while(i < a){
                        //                            //评论内容初始化
                        //                            model1.append({"portrait": danMuSql.getAvatar(),"name": danMuSql.getName(),"commenttext": danMuSql.getComments()});


                        //                            i++;
                        //                        }
                        //                        if(model1.get(0).name == ""){
                        //                            model1.remove(0)
                        //                        }
        ...
        Rectangle{
            ...
            Text {
                ...
                text: qsTr("选集")
                font.pixelSize: 25
                anchors.top: introductionDesc.bottom
