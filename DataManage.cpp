...
#include <QRegExp>
//Mysql::Mysql(){}
DataManage::DataManage(QGuiApplication &app,QQmlApplicationEngine &engine)
{
...
void DataManage::queryInfo(QString num)
{
    QSqlQuery query;
...
int DataManage::setKey(QString key)
{
    m_key=key;
    QSqlQuery query;
