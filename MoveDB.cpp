...
void Mysql::InsertInfo1(){
    ...
    query.prepare("insert into VedioInfo0(ve_name, ve_director,introduce, ve_role,ve_episodes,ve_image,ve_time) values(:name, :director, :introduce, :role, :episodes,:moveimage,:time)");
